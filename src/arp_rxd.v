...
module arp_rxd
   (
    ...
    (*mark_debug="true"*)  input                gmii_rxdv , //GMII输入数据有效信号
     ...
     (*mark_debug="true"*) output  reg          arp_rx_done, //ARP接收完成信号
     (*mark_debug="true"*) output  reg          arp_rx_type, //ARP接收类型 0:请求  1:应答
     (*mark_debug="true"*) output  reg  [47:0]  source_mac    , //接收到的源MAC地址
     (*mark_debug="true"*) output  reg  [31:0]  source_ip       //接收到的源IP地址
    );
